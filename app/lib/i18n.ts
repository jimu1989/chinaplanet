...
export const translations = {
  ...
  "سجّل دخولك للوصول إلى حسابك وتجربتك الخاصة مع China Planet.",
      ...
      createFailed: "تعذر إنشاء الحساب. حاول مرة أخرى.",
      profileFailed:
      ...
      teamDenied: "هذا الحساب ليس لديه صلاحية دخول الفريق.",
      accountCheckFailed: "تعذر التحقق من الحساب.",
      home: "الرئيسية",
    },
  ...
  "Sign in to access your account and your personalized China Planet experience.",
      ...
      loginTitle: "Login",
      loginDescription: "Enter your account details to continue.",
      email: "Email",
      password: "Password",
      ...
      resetDescription: "Enter your new account password.",
      newPassword: "New password",
      changingPassword: "Changing password...",
      changePassword: "Change password",
      forgotEmail: "Enter your email address first.",
      ...
      teamSecure: "Secure workspace for team members",
      teamDenied: "This account does not have team access.",
      accountCheckFailed: "Unable to verify the account.",
      home: "Home",
    },
  ...
  "登录您的账户，享受专属的中国星球体验。",
      ...
      hasAccount: "已经有账户？",
      resetTitle: "修改密码",
      resetDescription: "请输入您的新密码。",
      newPassword: "新密码",
      changingPassword: "正在修改密码...",
      changePassword: "修改密码",
      forgotEmail: "请先输入您的电子邮箱。",
      ...
      resetFailed: "无法发送密码重置链接，请重试。",
      accountCreated: "账户创建成功，请检查邮箱并确认账户。",
      createFailed: "无法创建账户，请重试。",
      profileFailed: "账户已创建，但个人资料保存失败。",
      resetSuccess: "密码修改成功，即将跳转到登录页面。",
      resetFailedExpired:
        "无法修改密码，重置链接可能已过期。",
      teamAccess: "团队登录",
      teamAccessLabel: "TEAM ACCESS",
      ...
      teamLogin: "团队登录",
      teamSecure: "团队成员安全工作区",
      teamDenied: "此账户没有团队访问权限。",
      accountCheckFailed: "无法验证账户。",
      home: "首页",
    },
