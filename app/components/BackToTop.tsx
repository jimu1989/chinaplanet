...
export default function BackToTop() {
  ...
  return (
    <button
      ...
      className={`fixed bottom-6 end-6 z-50 flex h-12 w-12 items-center justify-center rounded-full border border-[var(--cp-line-dark)] bg-[var(--cp-ivory)]/92 text-[var(--cp-brown)] shadow-[0_10px_30px_rgba(40,30,20,0.10)] backdrop-blur-md transition-all duration-300 hover:-translate-y-1 hover:bg-[var(--cp-red)] hover:text-white hover:shadow-[0_14px_35px_rgba(201,74,61,0.20)] sm:bottom-8 sm:end-8 ${
        visible
