        ...
        <section className="mt-10">
          <div className="mb-8">
            ...
            <p className="mt-3 max-w-2xl text-sm leading-7 text-[#8a8179]">
              الأدوات المتاحة لك تعتمد على الدور والصلاحيات
              المرتبطة بحسابك.
            </p>
          </div>
              ...
              <>
                ...
                >
                  ...
                  <p className="mt-3 text-sm leading-7 text-[#8a8179]">
                    إدارة أعضاء الفريق وتحديد الأدوار
                    والصلاحيات.
                  </p>
                ...
                >
                  ...
                  <p className="mt-3 text-sm leading-7 text-[#8a8179]">
                    التحكم في الصلاحيات الممنوحة لكل دور
                    داخل الفريق.
                  </p>
          ...
          <section className="relative mt-10 overflow-hidden rounded-[38px] bg-[#171717] p-8 text-white lg:p-12">
            ...
            <div className="relative z-10 max-w-3xl">
              ...
              <p className="mt-5 text-sm leading-8 text-white/60">
                ...
                يمكنك إدارة أعضاء الفريق والأدوار والصلاحيات
                والعمليات الداخلية للمشروع.
              </p>
